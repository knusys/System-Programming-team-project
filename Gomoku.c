...
//
// description:
// PC와 게임하는 알고리즘은 고정된 알고리즘입니다. 위에 링크에서 표로 점수 더하고 PC는 바둑돌이 어디에 두는지 알을 수 있습니다.
// horizontal, vertical, LeftObli, RightObl 네 함수는 방향마다 알고리즘 점수를 계산하는 알고리즘입니다.
//
// 생(活) : 바둑돌들이 몇 개 연결되었습니다.중간에 공백이 없습니다.머리나 꼬리부터 바둑판의 편까지 적어도 공백이 하나 있습니다.
// 반생(半活) : 바둑돌들이 연결되지 않았습니다.중간에 공백이 하나 있습니다.머리나 꼬리부터 바둑판의 편까지 적어도 공백이 하나 있습니다.
// 사(死) : 바둑돌들이 몇 개 연결되었습니다.중간에 공백이 없습니다.하지만 머리나 꼬리가 바둑판의 편과 붙였습니다.
// 반사(半死) : 바둑돌들이 연결되지 않았습니다.중간에 공백이 하나 있습니다.그리고 머리나 꼬리가 바둑판의 편과 붙였습니다.
#include <stdio.h>
#include <stdlib.h>
#define WIDTH 15
#define HEIGHT 15
